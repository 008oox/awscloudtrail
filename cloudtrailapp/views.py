        ...
        for Dict in UserList:
            ...
            for record in filtered_events:
                ...
                output = {
                    ...
                    "UserAgent": record["CloudTrailEvent"]["userAgent"][:100],
                    "EventTime": record["EventTime"],
                    "EventType": record["CloudTrailEvent"]["eventType"],
...
def cloudtrail_records(request):
    ...
    if request.method == "POST":
        ...
        eventtype_filter = request.POST.get("EventType", "")
        ...
        request.session["eventtype_filter"] = eventtype_filter
        ...
        eventtype_filter = request.session.get("eventtype_filter", "")
